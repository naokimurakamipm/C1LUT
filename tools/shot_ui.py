...
def main() -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        try:
            ...
            app.status_text.set("完了: 2 ファイル (平均 ΔE2000 0.0019 / lcms2 独立検証 PASS)")
            app.log("Gold200.cube -> LeicaSL601-Gold200.icc")
            app.log("  Validation: mean dE00 0.0019 / p95 0.0041 / max 0.0288 -> PASS")
            app.log("  lcms2 check: mean 0.0021 / max 0.0304")
            app.log("Teal_Light.cube -> LeicaSL601-Teal_Light.icc")
